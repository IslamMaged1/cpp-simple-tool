...
### What I learned
How a while loop works, bugs related to semicolon endings (for example placing one int the same line as the while condition) and the logic behind the binary conversion.
